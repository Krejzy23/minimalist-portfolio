...
const Hero = () => {
  ...
  return (
    <div className="pb-20 pt-36">
      ...
      <div className="absolute top-0 left-O h-screen w-full dark:bg-black-100 bg-white dark:bg-grid-white/[0.04] bg-grid-black/[0.2] flex items-center justify-center">
      ...
      <div className="relative flex justify-center my-20 z-10">
        <div className="flex flex-col items-center justify-center max-w-[89vw] md:max-w-2xl lg:max-w-[60vw]">
          ...
          <div className="text-center text-[40px] md:text-4xl lg:text-6xl">
            <h1 className="tracking-wider font-semibold">Creating Amazing User</h1>
             <FlipWords className="tracking-widest font-bold  lg:mt-4" words={["Interfaces", "Journeys", "Interactions"]} />
          </div>
